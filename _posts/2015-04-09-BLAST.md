...
Instead of typing the command 6 times, lets use a __for loop__.   If you haven't already done so, take a minute to read up on [for loops](post_url 2015-04-07-bash_for_loops.md).  __You can stop after exercise one__.
