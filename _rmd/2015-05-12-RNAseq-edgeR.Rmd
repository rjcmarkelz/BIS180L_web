...
__a__ Provide a line of code that displays the counts of the first 6 genes.  Not very interesting because the first genes in the file are on chromosome A03 (strange numbering...) and our bam file only has counts from A01...  
__b__ `Bra011030` is on chromosome A01.  What are its read counts in the two files?
