...
We need to get the populations assignments from PSmix in the same data.frame as the MDS genotype assignments and the phenotypic data.  You may need to remake some of the object below by re-running your code from Tuesday's lab.
```{r ,echo=F,results='hide'}
load("data_from_day_2.RData")
```
