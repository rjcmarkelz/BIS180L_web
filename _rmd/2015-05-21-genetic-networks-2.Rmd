...
```{r, eval = FALSE}
sum(cities_mat)/2 # divide by 2 because the matrix is has 2 values for each edge
```
...
```{r, eval = FALSE}
E(cities_graph2)$weight
plot.igraph(cities_graph2,vertex.label=V(cities_graph2)$name,layout=
	layout.fruchterman.reingold, edge.color="black",edge.width= (1/E(cities_graph2)$weight))

plot.igraph(cities_graph2, layout = layout.fruchterman.reingold, edge.color="black",
	edge.width= (1000/E(cities_graph2)$weight))
```
