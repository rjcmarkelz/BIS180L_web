...
Start a new RMarkdown document.  Choose "File > New File > RMarkdown" or click on the new file icon and choose RMarkdown.  From the pop-up menu you can enter a title (Maybe "Intro to R") and your name as author name.  Leave the type as "document" and the output as "html".  (_Optional_: If you want the ability to create PDFs from Rmarkdown then in the terminal type `sudo apt-get install texlive-latex-extra texlive-fonts-recommended`.  Be prepared to wait for a bit while the programs install)
