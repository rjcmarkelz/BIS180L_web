...
You will record your work today in an R-script file.  Create a new file by clicking on the icon with a "+" symbol, upper left, or going to the file menu, or typing Ctrl-shift-N.  This will create a new panel, upper left, in your R Studio window.

There are total of four panes in the R Studio window.
...
#R Script for BIS180L, Intro to R.
#Julin Maloof
