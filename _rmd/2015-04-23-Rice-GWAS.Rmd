...
We need to get the population assignments from PSmix in the same data frame as the MDS genotype assignments and the phenotypic data.  You should have save this at the end of Tuesday's lab
...
It might be intersting to ask if the distributions look similar for different regions.
...
pl #display the plot
```
We are a little sparse on data for this to be a great way to visualize the results.
